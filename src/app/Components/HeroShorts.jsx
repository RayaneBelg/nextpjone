...
export default function HeroShorts() {
  ...
  const videos = [
    { id: 1, src: "/head.mov", title: "Yellow Tomato Pasta", views: "52k views" },
    { id: 2, src: "/mozza.mp4", title: "Youssef Boughanem Talk", views: "68k views" },
    { id: 3, src: "/head.mov", title: "When Ada's Collar Gets Bored", views: "102k views" },
    { id: 4, src: "/mozza.mp4", title: "When Ada's Collar Gets Bored", views: "102k views" },
  ];
      ...
      {!isFullScreen && (
        <div className="h-[calc(100%)] flex flex-col justify-center items-center overflow-hidden">
          <div className="text-center p-4">
            ...
            <p></p>
            <img className="h-14" src="/IconeBlack.png"/>
          </div>
