const menu = [
    ...
    { id: 11, type: "pizzas", plat: "plat chaud", nom: "Quatre Fromages", description: "Un mélange harmonieux de mozzarella, gorgonzola, parmesan et chèvre pour une explosion de saveurs.", prix: 14.5, src: "../../rbryani.png" },
